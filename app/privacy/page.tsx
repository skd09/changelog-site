...
export default function PrivacyPage() {
  return (
    <PolicyLayout title="PRIVACY POLICY" updated="FEBRUARY 2026">
      ...
      <p>
        Data is stored on servers hosted by DigitalOcean in the United States. Our database is provided
        by Neon (serverless PostgreSQL). Both providers maintain industry-standard security practices.
